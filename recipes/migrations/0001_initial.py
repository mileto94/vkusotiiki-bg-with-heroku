# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-01-04 21:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('holiday', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='recipes.Holiday', verbose_name='Prepared for holiday')),
            ],
        ),
        migrations.CreateModel(
            name='RecipeImage',
